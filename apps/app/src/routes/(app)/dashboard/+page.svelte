...
<div class="flex flex-col 2xl:flex-row gap-8 min-h-screen relative" in:fade>
    ...
    <div class="flex-1 space-y-8">
        <div class="flex flex-col sm:flex-row justify-between items-start gap-4">
            <div>
            <div>
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">Main Dashboard <span class="text-xs font-normal text-gray-400 opacity-50 ml-2">(Build: 2000)</span></h1>
