...
<div class="flex flex-col border-black {className}">
    <!-- Choice 1 Row -->
    <div class="flex {borderClass} min-h-[40px]">
        <div class="flex items-center justify-center font-bold {textClass} tabular-nums" style="width: {snoWidth}px">
            {qNumber}.
        </div>
        <div class="flex-1 px-2 py-2 {textClass} leading-relaxed relative group whitespace-pre-wrap">
        ...
        <div class="flex items-center justify-center font-bold text-xs tabular-nums px-2 {marksClass}">
            <span>(</span>
            <AssessmentEditable 
